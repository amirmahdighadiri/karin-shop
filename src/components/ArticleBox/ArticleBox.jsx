...
function ArticleBox({title , src, viewCount, createdAt}) {

    function formatJalaliDate(createdAtNumber) {
        const dateString = String(createdAtNumber);
    ...
    return (
        <div className="p-2 bg-white dark:bg-gray-800 rounded-lg shadow-sm group">
            ...
            <div className="relative rounded-lg rounded-tr-3xl rounded-bl-3xl overflow-hidden">
                ...
                <Link to="/article" className="absolute inset-0 flex-center bg-black/60 opacity-0 group-hover:opacity-100 transition-all cursor-pointer">
                    <span to="/article" className="flex items-center font-Dana-Medium rounded-lg border-2 border-white text-white px-2 py-1">
            ...
            <div className="">
                ...
                <div className="flex items-center justify-between border-t border-gray-100 dark:border-white/10 pt-1">
                    ...
                    <div className="flex items-center gap-x-1 text-blue-500 dark:text-sky-400">
                        ...
                        <span className="text-sm pt-1">{formatJalaliDate(createdAt)}</span>
                    </div>
                    {/* ! ================== ! Viwe Count ! ================== ! */}
                    <div className="flex items-center gap-x-1 text-gray-300">
                        <span className="font-Dana-DemiBold text-sm">{viewCount}</span>
