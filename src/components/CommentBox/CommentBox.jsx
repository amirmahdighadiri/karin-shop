    ...
    return (
        <div className="py-4">
            ...
            <div className="flex items-center gap-x-2">
                <h3 className="font-Dana-Medium text-zinc-900 dark:text-zinc-100 text-lg">عملکرد سریع و روان</h3>
            ...
            {/* ! ================== ! Comment Text ! ================== ! */}
            <p className="text-gray-500 dark:text-gray-200 mb-2 line-clamp-2">موبایل بسیار سریعی هست، اجرای برنامه‌ها بدون لگ انجام میشه. کیفیت ساخت بدنه هم عالیه.</p>
            {/* ! ================== ! Comment Details ! ================== ! */}
            <div className="flex items-center justify-between">
                {/* ! ================== ! Comment Date & User Name ! ================== ! */}
                <div className="flex items-center gap-x-4 text-gray-400 text-sm">
                    <span className="">11 بهمن 1402</span>
                    <span className="">امیررضا کریمی</span>
                </div>
