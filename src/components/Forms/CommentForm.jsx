...
function CommentForm(props) {
    ...
    const sendCommentToServer = evnet =>{
    ...
    return (
        <form className="w-1/4">
            ...
            <button type="submit" onClick={sendCommentToServer} className="w-full bg-blue-500 hover:bg-blue-600 text-white rounded-lg p-2 cursor-pointer transition-all">ثبت</button>
        </form>
    );
}
