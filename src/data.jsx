const category = [
    {id: 1, title: "موبایل", src: "/images/banner/5.png"},
    {id: 2, title: "کالای دیجیتال", src: "/images/banner/6.png"},
    {id: 3, title: "خانه و آشپزخانه", src: "/images/banner/7.png"},
    {id: 4, title: "آرایشی بهداشتی", src: "/images/banner/8.png"},
    {id: 5, title: "لوازم تحریر", src: "/images/banner/9.png"},
    {id: 6, title: "گیفت کارت", src: "/images/banner/10.png"},
    {id: 7, title: "ابزار آلات", src: "/images/banner/11.png"},
]

const prodcuts = [
    {
        id: 1,
        title: "لپ تاپ 15.6 اینچی ایسوس مدل Vivobook15 X515MA-BR001-Celeron N4020-8GB DDR4",
        price: 130000000,
        dicountPercent: 70,
        score: 5,
        todaySend: true,
        src: "/images/products/3.png",
        hoverSrc: "/images/products/4.png",
    },
    {
        id: 2,
        title: "لپ تاپ 15.6 اینچی ایسوس مدل Vivobook15 X515MA-BR001-Celeron N4020-8GB DDR4",
        ...
        hoverSrc: "/images/products/6.webp",
    },
    {
        id: 3,
        title: "لپ تاپ 15.6 اینچی ایسوس مدل Vivobook15 X515MA-BR001-Celeron N4020-8GB DDR4",
        ...
        hoverSrc: "/images/products/2.png",
    },
    {
        id: 4,
        title: "لپ تاپ 15.6 اینچی ایسوس مدل Vivobook15 X515MA-BR001-Celeron N4020-8GB DDR4",
        ...
        hoverSrc: "/images/products/8.webp",
    },
    {
        id: 5,
        title: "لپ تاپ 15.6 اینچی ایسوس مدل Vivobook15 X515MA-BR001-Celeron N4020-8GB DDR4",
...
const brands = [
    {id: 1, title: "", src: "/images/brands/1.png"},
    {id: 2, title: "", src: "/images/brands/2.png"},
    {id: 3, title: "", src: "/images/brands/4.webp"},
    {id: 4, title: "", src: "/images/brands/5.webp"},
    {id: 5, title: "", src: "/images/brands/6.webp"},
    {id: 6, title: "", src: "/images/brands/7.png"}
]

const articles = [
    {
        id: 1,
        title: "بهترین لپ تاپ های بازار ایران [دی ۱۴۰۳]",
...
const filterCategory = [
    {id: 1, inputId: "all", title: "همه کالاها", checked: false},
    {id: 2, inputId: "mobile", title: "موبایل", checked: false},
    {id: 3, inputId: "laptop", title: "لپ تاپ", checked: false},
    {id: 4, inputId: "headset", title: "هدفون، هدست", checked: false},
]

const productLiveTexts = [
    {colorName: "red-500", text: "🔥 ۱۰۰۰+ فروش در هفته گذشته"},
    {colorName: "blue-600", text: "🛒 در سبد خرید ۱۰۰۰+ نفر"},
...
const services = [
    {
        ...
        icon:(<svg xmlns="http://www.w3.org/2000/svg" id="arrow-path-rounded-square" fill="none" stroke="currentColor" strokeWidth="1.5" className="size-4 lg:size-6" viewBox="0 0 24 24">
    ...
    },
    {
        ...
        icon:(<svg xmlns="http://www.w3.org/2000/svg" id="check-badge" fill="none" stroke="currentColor" strokeWidth="1.5" className="size-4 lg:size-6" viewBox="0 0 24 24">
    ...
    {
        id: 3,
        title: "پشتیبانی کل هفته",
        icon:(<svg xmlns="http://www.w3.org/2000/svg" id="calender-day" fill="none" stroke="currentColor" strokeWidth="1.5" className="size-4 lg:size-6" viewBox="0 0 24 24">
    ...
    },
    {
        ...
        icon:(<svg xmlns="http://www.w3.org/2000/svg" id="truke" fill="none" stroke="currentColor" strokeWidth="1.5" className="size-4 lg:size-6" viewBox="0 0 24 24">
